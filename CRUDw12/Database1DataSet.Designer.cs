...
namespace CRUDw12 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class vehiclesDataTable : global::System.Data.TypedTableBase<vehiclesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public vehiclesRow AddvehiclesRow(string name, int wheels) {
        ...
        public partial class vehiclesRow : global::System.Data.DataRow {
            ...
            public int wheels {
                get {
                    try {
                        return ((int)(this[this.tablevehicles.wheelsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'wheels\' in table \'vehicles\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablevehicles.wheelsColumn] = value;
                }
            }
            ...
            public bool IswheelsNull() {
                return this.IsNull(this.tablevehicles.wheelsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetwheelsNull() {
                this[this.tablevehicles.wheelsColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace CRUDw12.Database1DataSetTableAdapters {
    ...
    public partial class vehiclesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[vehicles] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 " +
                "AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_wheels = 1 AND [" +
                "wheels] IS NULL) OR ([wheels] = @Original_wheels)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[vehicles] ([name], [wheels]) VALUES (@name, @wheels);\r\nSELECT " +
                "Id, name, wheels FROM vehicles WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[vehicles] SET [name] = @name, [wheels] = @wheels WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_wheels = 1 AND [wheels] IS NULL) OR ([wheels] = @Original_wheels)));
SELECT Id, name, wheels FROM vehicles WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUDw12.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, wheels FROM dbo.vehicles";
            ...
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[vehicles] ([name], [wheels]) VALUES (@name, @wheels);\r\nSELECT " +
                "Id, name, wheels FROM vehicles WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@wheels", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "wheels", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Delete(int Original_Id, string Original_name, global::System.Nullable<int> Original_wheels) {
        ...
        public virtual int Insert(string name, global::System.Nullable<int> wheels) {
            if ((name == null)) {
            ...
            if ((wheels.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((int)(wheels.Value));
            }
            else {
        ...
        public virtual int Update(string name, global::System.Nullable<int> wheels, int Original_Id, string Original_name, global::System.Nullable<int> Original_wheels, int Id) {
            if ((name == null)) {
            ...
            if ((wheels.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(wheels.Value));
            }
            else {
            ...
            if ((Original_wheels.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_wheels.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> wheels, int Original_Id, string Original_name, global::System.Nullable<int> Original_wheels) {
            return this.Update(name, wheels, Original_Id, Original_name, Original_wheels, Original_Id);
        }
        ...
        public virtual int InsertQuery(string name, global::System.Nullable<int> wheels) {
            ...
            if ((wheels.HasValue == true)) {
                command.Parameters[1].Value = ((int)(wheels.Value));
            }
            else {
